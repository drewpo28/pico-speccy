...
#define TXT_TAPE_WEAR       "Tape wear (for fun)"
...
#define TXT_DLG_SLOT_OVER    "Slot is not empty. Overwrite?"
...
#define TXT_MSG_SLOT_EMPTY   " Slot is empty "
#define TXT_PROF_NAME        "Profile name"
#define TXT_SLOT_NAME        "Snapshot name"
#define TXT_SLOT_NONAME      "(no name)"
#define TXT_MSG_SNAP_ERR     " Cannot load the snapshot "
#define TXT_MSG_SNAP_SAVE_ERR " Cannot save the snapshot "
#define TXT_MSG_LOADING      " Loading... "
#define TXT_MSG_SAVING_SNAP  " Saving... "
