#pragma once
#include <stdint.h>
// Scorpion ZS-256 v2.95 64K ROM, CRC32 0C6C1EF6 (page order 0=BASIC-128,
// 1=BASIC-48, 2=service monitor, 3=TR-DOS 5.03 variant). bank0/bank1 are tiny
// overlays over the Sinclair 128K halves (scorpion_overlays.h, 434+182 B); bank2 is
// unique code and bank3 diffs ~30% from the trdos base AND rom[4] already overlays
// that base pointer (MemESP::registerOverlay is keyed by base) — both stay raw.
// Declared by the GENERATED header, not here: bank2/bank3 are emitted straight from
// src/bank{2,3}.bin by `python3 tools/rom_pack.py scorpion`, and hand-written copies
