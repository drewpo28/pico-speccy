// ROM 0 48K Sinclair (also the base for 48K es/byte overlays). Defined here (C
// linkage, single copy) instead of inline in the header to avoid per-TU duplicates.
