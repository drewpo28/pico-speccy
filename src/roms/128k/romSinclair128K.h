#ifndef ROM_SINCLAIR_128K_H
 #define ROM_SINCLAIR_128K_H
//ROM 0,1
//ROM 0 128K SINCLAIR - no longer a raw array here: rom[0] of this family is
// the PENTAGON ROM0 base (roms/pentagon/pentagon_base.c), and the stock Sinclair
// first half is gb_overlay_pentagon_sinclair_128k_0, a 101-byte run list over it
// (tools/rom_pack.py). The base had to be the Pentagon variant because TS-Conf
// reads that ROM as a raw pointer (TsConf::romPtr) and cannot see an overlay.




//ROM 1 128K SINCLAIR
const unsigned char gb_rom_1_sinclair_128k[]={
...
// 0xFE,0xC9,0x21,0x3F,0x05,0x64,0x21,0x80,0x1F,0xCB,0x7F,0x28,0x03,0x21,0x98,0x0C, // Instruction 0xE5 replaced with 0x64 (LD H,H) to mark the save trap at SA_BYTES
...
// 0x05,0xE5,0xDB,0xFE,0x1F,0xE6,0x20,0xF6,0x02,0x64,0xBF,0xC0,0xCD,0xE7,0x05,0x30, // Instruction 0x4F replaced with 0x64 (LD H,H) to mark the tape load trap
...
// 0x64,0x3E,0xFD,0xCD,0x01,0x16,0xAF,0x11,0xA1,0x09,0xCD,0x0A,0x0C,0xFD,0xCB,0x02, // Instruction 0xE5 replaced with 0x64 (LD H,H) to mark the tape save SA_CONTRL trap
