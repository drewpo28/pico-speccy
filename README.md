...
- ATM-Turbo emulation (Machine → ATM-Turbo, NOT yet tested on hardware): ATM-Turbo 1 (BIOS 1.04rs, 1 MB, #FE address-latch paging) and ATM-Turbo 2+ (BIOS 1.07.13 or xBIOS 1.37, 1 MB, the #77/#F7 memory manager, 7 MHz turbo, on-board IDE as IDE/HDD → ATM), with the 16-entry palette and every video mode (ZX, EGA 320x200x16, hires 640x200, 80x25 text on the 2+). Needs a board with QSPI (butter) PSRAM and VGA/HDMI output.
